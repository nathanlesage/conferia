var Conferia = (function () {
  ...
  */
  ...
  function parseCsv(csvData, timeZone, dateParser, rowParser) {
      ...
      const sessionNamesAndTimes = new Map(onlySessionPresentations.map(s => {
   ...
   */
  function parseCSVLine(line, lineNo, sep = ',') {
      const cells = [];
      let currentCell = '';
      let isQuoted = false;
   ...
   */
  function generateEventCard(event, agenda, options) {
   ...
   */
  function showEventDetailsModal(event, conferia, opt) {
   ...
   */
  function generateEventDOMStructure(event, config) {
   ...
   */
  async function askUser(title, message, buttons) {
...
agenda.`, [
  ...
  var smartphoneIcon = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"feather feather-smartphone\"><rect x=\"5\" y=\"2\" width=\"14\" height=\"20\" rx=\"2\" ry=\"2\"></rect><line x1=\"12\" y1=\"18\" x2=\"12.01\" y2=\"18\"></line></svg>";

  var downloadIcon = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"feather feather-download\"><path d=\"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4\"></path><polyline points=\"7 10 12 15 17 10\"></polyline><line x1=\"12\" y1=\"15\" x2=\"12\" y2=\"3\"></line></svg>";
  ...
  class Conferia {
      ...
      updateUI() {
          ...
          if (isConferenceNow(this.state.get('records'))) {
              ...
              // Always show the last update status, even if we're not auto-scrolling.
              this.dom.liveActionsStatusMessage.textContent = this.state.get('lastUpdate').toRelative();
